...
requests_cache.install_cache('ghtix_cache', backend='sqlite', expire_after=9)
...
if __name__ == '__main__':
    ...
    with open('/var/www/labs/ksdev/tickets.html', 'w') as htmlfh:
    ...
    with open('/var/www/labs/ksdev/index.html', 'w') as htmlfh:
